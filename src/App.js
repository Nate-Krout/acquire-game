...
const styles = {
  ...
  body: { display: "flex", flex: 1, gap: 0, overflow: "visible", flexDirection: "column" },
  boardWrap: { flex: "0 0 auto", padding: "12px", display: "flex", flexDirection: "column", gap: 8, overflowX: "auto", maxWidth: "100%", WebkitOverflowScrolling: "touch" },
  ...
  sidebar: { flex: 1, display: "flex", flexDirection: "column", gap: 0, borderLeft: "1px solid #1a2a1a", overflowY: "visible", width: "100%", maxWidth: "100%" },
